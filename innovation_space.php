...
<! MAIN >	
	...
	<div class="project-hero innovation_space-project-hero">
	</div>
		...
		<section class="project-meta">
			<div class="project-inner-wrapper">
				...
				<a class="button project-button" href="innovation_space-amedy.php">View Amedy</a><br>
				<a class="button project-button" href="innovation_space-satlas.php">View Satlas</a><br>
				<a class="button project-button" href="innovation_space-phero.php">View Phero</a><br>
		...
		<section class="project-gallery">
			<img class="gallery-image" src="_/assets/projects/innovation_space/kwill-logo.jpg">
			<img class="gallery-image" src="_/assets/projects/innovation_space/innovation_proposal-01.jpg">
			<img class="gallery-image" src="_/assets/projects/innovation_space/innovation_proposal-02.jpg">
			<img class="gallery-image" src="_/assets/projects/innovation_space/innovation_proposal-04.jpg">
			<img class="gallery-image" src="_/assets/projects/innovation_space/innovation_proposal-05.jpg">
			<img class="gallery-image" src="_/assets/projects/innovation_space/innovation_proposal-07.jpg">
			<img class="gallery-image" src="_/assets/projects/innovation_space/innovation_proposal-08.jpg">
			<img class="gallery-image" src="_/assets/projects/innovation_space/innovation_proposal-09.jpg">
			<img class="gallery-image" src="_/assets/projects/innovation_space/innovation_proposal-22.jpg">
		</section>
