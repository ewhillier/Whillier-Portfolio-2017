...
<head>
	...
	<title>Eve Whillier Design</title>
</head>
...
<! MAIN >	
	<main class="homepage-main">
		...
		<section class="project-description landAppearHomeSub">
			<h1>Say goodbye to<br class="mobileHidden"> the sticky past.</h1>
			<h2>Parker's Real Maple</h2>
			<a class="button buttonPulse" href="parkers_maple.php">View</a>
		</section>
